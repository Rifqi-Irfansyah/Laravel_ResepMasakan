...
<div class="content-wrapper"><br><br>
    ...
    <div class="alert  bg-orange ml-5 mr-5" role="alert">
    ...
    <div class="container" align="center" >
        <div class="card mt-3">
            <div class="card-body">
                <a href="/upload" class="btn bg-dark float-sm-left">Input Resep</a>
                <br><br>
                            ...
                            <td> 
                                <button  class="bg-secondary">
                                    <a href="/editresep/ubah/{{ $g->id }}" class="text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                <button  class="bg-danger">
                                    <a href="/editresep/hapusdata/{{ $g->id }}" class="text-white" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?');">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
