...
@section('sidebar')
            ...
            <li class="nav-item">
            <a href="{{route('resepmasakan')}}" class="nav-link bg-dark">
    ...
    <li class="nav-item menu-open">
        ...
        <ul class="nav nav-treeview">
            ...
            <a href="{{route('minuman')}}" class="nav-link">
                <i class="fas fas fa-mug-hot nav-icon"></i>
                <p>Minuman</p>
            </a>
            </li>
        </ul>
...
<div class="content-wrapper">
        <div class="card-body"><br><br>
            <div class="card-header text-center font-weight-bold">
                <h3><strong>Resep Masakan</strong></h3>
            </div>
                            ...
                            <div class="card bg-success">
                                <div class="card-body">
                                    ...
                                    <div class=""> 
                                        ...
                                        <a width="100%" href="/resepmasakan/detailresep/{{ $g->id }}" class="btn btn-block bg-secondary">Lihat Resep</a>
                                    </div>
                                </div>
                            </div>
                        </div>
